...
public class CalendarReal {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.cssSelector(".react-calendar__navigation__label")).click();
		driver.findElement(By.xpath("//button[text()='"+year+"']")).click();  //we gave a "+year+" to select that via our input
		...
		for(int i=0; i<actualList.size(); i++)
		{
			...
			Assert.assertEquals(actualList.get(i).getAttribute("value"), calendar[i]);
		}
